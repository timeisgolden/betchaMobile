                      ...
                      children: [
                            ...
                            children: [
                              Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'HOME_PAGE_Row_ip1j5kw1_ON_TAP');
                                    logFirebaseEvent('Row_navigate_to');

                                    context.pushNamed('CreateWager');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                        ...
                        Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(),
                            child: wrapWithModel(
                              model: _model.cardLiveChallengeModel,
                              updateCallback: () => setState(() {}),
                              child: CardLiveChallengeWidget(),
                            ),
                          ),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Row(
                              ...
                              children: [
                                wrapWithModel(
                                  model: _model.cardUpcomingEventModel1,
                                  updateCallback: () => setState(() {}),
                                  child: CardUpcomingEventWidget(),
                                ),
                                wrapWithModel(
                                  model: _model.cardUpcomingEventModel2,
                                  updateCallback: () => setState(() {}),
                                  child: CardUpcomingEventWidget(),
                                ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.cardChallengeModel,
                                updateCallback: () => setState(() {}),
                                child: CardChallengeWidget(
                                  avatarUrl: 'test',
                                  title1: 'NBA 2k',
                                  title2: '1v1 Mode',
                                  username: 'JaredJCarter',
                                  betText: 'W 34 - L 31',
                                  wagerPrice: '\$70',
                                ),
                              ),
