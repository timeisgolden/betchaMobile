...
final parametersBuilderMap =
  ...
  'Resetyourpassword': ParameterData.none(),
  'PasswordRecovery': ParameterData.none(),
  'Home': ParameterData.none(),
  'Wallet': ParameterData.none(),
  'Inbox': ParameterData.none(),
  'Profile_Page': ParameterData.none(),
  'MainPofile': ParameterData.none(),
  'AccountInfo': ParameterData.none(),
  'PaymentMethod': ParameterData.none(),
  'NewCard': ParameterData.none(),
  'Deliveryaddresss': ParameterData.none(),
  'Notifications': ParameterData.none(),
  'Orders-1': ParameterData.none(),
