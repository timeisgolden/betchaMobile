...
import 'other_profile_detail_model.dart';
export 'other_profile_detail_model.dart';

class OtherProfileDetailWidget extends StatefulWidget {
  const OtherProfileDetailWidget({
    Key? key,
  ...
  @override
  _OtherProfileDetailWidgetState createState() =>
      _OtherProfileDetailWidgetState();
}

class _OtherProfileDetailWidgetState extends State<OtherProfileDetailWidget> {
  late OtherProfileDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtherProfileDetailModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'OtherProfileDetail'});
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('OTHER_PROFILE_DETAIL_chevron_left_ICN_ON');
