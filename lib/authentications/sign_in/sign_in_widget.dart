                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'SIGN_IN_PAGE_LOG_IN_BTN_ON_TAP');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SIGN_IN_PAGE_Container_la2mhq9c_ON_TAP');
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SIGN_IN_PAGE_Container_9w2np8pn_ON_TAP');
                                        logFirebaseEvent('Container_auth');
                                        GoRouter.of(context).prepareAuthEvent();
                                        final user = await authManager
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SIGN_IN_PAGE_Text_4rz1k7k3_ON_TAP');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SIGN_IN_PAGE_Text_1vop5oza_ON_TAP');
                                        logFirebaseEvent('Text_navigate_to');
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent('SIGN_IN_PAGE_chevron_left_ICN_ON_TAP');
