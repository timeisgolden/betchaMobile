...
class _PasswordRecoveryWidgetState extends State<PasswordRecoveryWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PasswordRecovery'});
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 42.0, 0.0, 42.0),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PASSWORD_RECOVERY_SEND_LINK_BTN_ON_TAP');
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent(
                        'PASSWORD_RECOVERY_chevron_left_ICN_ON_TA');
